...
from src.utils.loss import LatentRegularizerLoss, ImageFocusLatentRegularizerLoss, LossPerceptual, LossWrapper
...
if __name__ == "__main__":
    ...
    loss_reconstruction = ImageFocusLatentRegularizerLoss(device, reg_lambda, encoding_lambda=0.00)
    # loss_fn = LatentRegularizerLoss(device, reg_lambda=reg_lambda)
    loss_perceptual = LossPerceptual()
    losses = [loss_reconstruction, loss_perceptual]
    weights = [1., 0.1]
    loss_fn = LossWrapper(losses, weights)
    print("Done.")
